...
public class Utility {
	 ...
	 * @param wdate
	 *            - 등록날짜
	 * @return - true:오늘,어제,그제중 등록날짜와 같음(new표시) false:오늘,어제,그제 날짜가 등록날짜와 다
	 *         다름(new 표시-X)
	 */
	 ...
	 * @return 페이징 생성 문자열
	 */
	public static String paging(int totalRecord, int nPage, int recordPerPage, String url, String no, int bbsno,
		...
		if (nowGrp >= 2) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&bbsno=" + bbsno + "&nPage=" + _nowPage + "'>이전</A></span>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nPage == i) {
				...
				str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col
						+ "&word=" + word + "&" + no + "=" + bbsno + "&nPage=" + i + "'>" + i + "</A></span>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&" + no + "=" + bbsno + "&nPage=" + _nowPage + "'>다음</A></span>");
		}
		str.append("</DIV>");
