...
<body style="margin: 0px">
	...
	<table>
		...
		<c:forEach var="dto" items="${list}">
			<tr bgcolor="#EEEEEE" onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#EEEEEE'">
				<td align='center'>${dto.calendarno}</td>
				<td align='center'>${dto.labeldate}</td>
				<td align='left'>
					<a href="javascript:f_update('${dto.calendarno}')">${dto.label}</a>
				</td>
				<td align='left'>
