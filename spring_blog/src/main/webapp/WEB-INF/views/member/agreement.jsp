...
최종 수정 날짜: 2014년 4월 14일 (이전 버전 보기)
...
법률상 허용되는 경우, Google, Google의 공급자 및 판매자는 일실이익, 일실수입, 망실자료, 재무적 손실, 간접 손해, 특별 손해, 결과적 손해, 징계적 손해, 또는 징벌적 손해에 대한 책임을 부담하지 않습니다.
...
본 약관 또는 서비스와 관련하여 발생하는 분쟁에 대해서는 미국 캘리포니아주 법률이 적용되며, 캘리포니아 주 국제사법의 적용은 배제됩니다. 본 약관 또는 서비스와 관련하여 발생되는 모든 소송은 독점적으로 미국 캘리포니아주 산타클라라 카운티의 연방 또는 주 법원에서 다루어지며 귀하와 Google은 이러한 법원이 인적 관할을 갖는 것에 동의합니다.
...
Google에 문의하는 방법을 보려면 문의 페이지를 참조하시기 바랍니다.
		...
		<div style="text-align: center">
			<label for="a01">
				<input id="a01" type="checkbox" name="agree" value="1">
				약관에 동의합니다
				</input>
			</label>
